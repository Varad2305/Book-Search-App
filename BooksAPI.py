...
def generate_result(link):                                  #Uses the Google Book   s API to get data which then, uses to create objects. Stores references to these objects in 2 different lists mentioned above
